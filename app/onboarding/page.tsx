      ...
      <div className="grid w-full gap-3">
        {(teams ?? []).map((team) => (
          <form key={team.id} action={setFavoriteTeam}>
            ...
            <button
              type="submit"
              className="flex w-full items-center gap-3 rounded-lg border border-black/10 p-4 text-left transition-colors hover:bg-black/5 dark:border-white/15 dark:hover:bg-white/10"
            >
              {team.logo_url && (
