...
const NATIONALITY_LABELS: Record<string, string> = {
  ...
  Tunisia: "Tunisien",
  Türkiye: "Turkiet",
  // api-football stavar samma land olika beroende på endpoint — "Türkiye"
  // ovan (med diakrit) träffar inte synonymnyckeln "turkiye", så den
  // engelska stavningen behöver en egen post.
  Turkey: "Turkiet",
  USA: "USA",
